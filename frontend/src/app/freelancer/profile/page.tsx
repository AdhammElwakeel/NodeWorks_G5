...
export default function FreelancerProfilePage() {
  ...
  useEffect(() => {
    if (!user) return;
    const fp = (user as { freelancerProfile?: Record<string, unknown> }).freelancerProfile ?? {};
    setForm({
      name: user.name || "",
      ...
      experience:         (fp.experience         as { role: string; company: string; years: string }[] | undefined) ?? [],
      education:          (fp.education          as { degree: string; institution: string }[] | undefined) ?? [],
      projects:           (fp.projects           as { name: string; technologies: string[] }[] | undefined) ?? [],
      certifications:     (fp.certifications     as { name: string }[] | undefined) ?? [],
  ...
  const handleCVReUpload = async (file: File | null) => {
    ...
    try {
      ...
      const res = await fetch(CV_ANALYSIS_URL, { method: "POST", body: formData });
      if (!res.ok) {
      ...
      setForm((prev) => ({
        ...
        experienceLevel: deriveExperienceLevel(data["years of experience"]) || prev.experienceLevel,
        yearsOfExperience: data["years of experience"] || prev.yearsOfExperience,
        ...
        education: data.education?.length
          ? data.education.map((e: { degree: string; institution: string }) => ({ degree: e.degree, institution: e.institution }))
          : prev.education,
  ...
  return (
    <ProtectedRoute requiredRole="freelancer">
      <Box style={{ minHeight: "100vh", backgroundColor: "#f8fafc", padding: "32px 24px" }}>
        <Box maw={800} mx="auto">
          {/* Back Button */}
          <Group mb="lg">
            <Button
          ...
          <Card withBorder radius="md" bg="white" mb="md">
            <Group mb="sm">
              ...
              <Text fw={600} c="dark.9">Re-upload CV</Text>
            </Group>
            <Text fz="sm" c="dimmed" mb="md">
              Upload a new CV to automatically update your profile fields with the latest data.
            </Text>
            ...
            {isAnalyzing && (
              <Alert icon={<Loader size="xs" />} color="blue" mt="sm" radius="md">
                Analyzing your CV with AI…
              </Alert>
            )}
            {analysisSuccess && !isAnalyzing && (
              <Alert icon={<CheckCircle size={16} />} color="teal" mt="sm" radius="md">
            ...
            {analysisError && !isAnalyzing && (
              <Alert icon={<AlertCircle size={16} />} color="red" mt="sm" radius="md">
                {analysisError}
              </Alert>
            )}
          </Card>
          ...
          <Card withBorder radius="md" bg="white" mb="md">
            <Group mb="md" gap="xs">
              ...
              <Text fw={600} c="dark.9">Work Experience</Text>
            </Group>
            {form.experience.length === 0 && (
              <Text fz="sm" c="dimmed">No experience added yet. Upload your CV to auto-fill.</Text>
            )}
            <Stack gap="xs">
              ...
              <Button
                variant="light"
                size="xs"
                onClick={() => update("experience", [...form.experience, { role: "", company: "", years: "" }])}
              >
                + Add Experience
              </Button>
            </Stack>
          ...
          <Card withBorder radius="md" bg="white" mb="md">
            <Group mb="md" gap="xs">
              ...
              <Text fw={600} c="dark.9">Education</Text>
            </Group>
            {form.education.length === 0 && (
              <Text fz="sm" c="dimmed">No education added yet. Upload your CV to auto-fill.</Text>
            )}
            <Stack gap="xs">
              ...
              <Button
                variant="light"
                size="xs"
                onClick={() => update("education", [...form.education, { degree: "", institution: "" }])}
              >
                + Add Education
              </Button>
            </Stack>
          ...
          <Card withBorder radius="md" bg="white" mb="md">
            <Group mb="md" gap="xs">
              ...
              <Text fw={600} c="dark.9">Projects</Text>
            </Group>
            {form.projects.length === 0 && (
              <Text fz="sm" c="dimmed">No projects added yet. Upload your CV to auto-fill.</Text>
            )}
            <Stack gap="xs">
              ...
              <Button
                variant="light"
                size="xs"
                onClick={() => update("projects", [...form.projects, { name: "", technologies: [] }])}
              >
                + Add Project
              </Button>
            </Stack>
          ...
          <Card withBorder radius="md" bg="white" mb="md">
            <Group mb="md" gap="xs">
              ...
              <Text fw={600} c="dark.9">Certifications</Text>
            </Group>
            {form.certifications.length === 0 && (
              <Text fz="sm" c="dimmed">No certifications added yet. Upload your CV to auto-fill.</Text>
            )}
            <Stack gap="xs">
              ...
              <Button
                variant="light"
                size="xs"
                onClick={() => update("certifications", [...form.certifications, { name: "" }])}
              >
                + Add Certification
              </Button>
            </Stack>
          ...
          <Card withBorder radius="md" bg="white" mb="xl">
            <Group mb="md" gap="xs">
              ...
              <Text fw={600} c="dark.9">Portfolio Links</Text>
            </Group>
            <TagsInput
          ...
          <Group justify="flex-end">
            <Button variant="default" component={Link} href="/freelancer/dashboard">
              Cancel
            </Button>
            <Button
              variant="gradient"
