...
const interviewApi = {
  ...
  saveResult: async (report: Report) => {
    await fetch("/api/interviews", {
      ...
      body: JSON.stringify({
        ...
        cheatingDetected: report.cheating_detected,
        skillScores: report.skill_scores.map((s) => ({
          skill: s.skill,
          score: s.score,
      ...
      console.warn("Failed to save interview results:", err);
    });
  },
};
    ...
    try {
      ...
      if (data.status === "completed") {
        const completedReport = {
          ...data.report,
          violations: violations + lookAways,
        } as Report;
        setReport(completedReport);
        await interviewApi.saveResult(completedReport);
        setPhase("done");
      } else {
